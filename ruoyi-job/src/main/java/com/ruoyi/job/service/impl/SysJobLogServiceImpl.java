...
public class SysJobLogServiceImpl implements ISysJobLogService {
    ...
    @Override
    public TableDataInfo<SysJobLog> selectJobLogPageList(SysJobLog sysJobLog, PageQuery pageQuery) {
        LambdaQueryWrapper<SysJobLog> lqw = new LambdaQueryWrapper<SysJobLog>();
        Page<SysJobLog> page = jobLogMapper.selectPage(pageQuery.build(), lqw);
